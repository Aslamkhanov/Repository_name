...
import homework3.immutab.City;
import homework3.immutab.House;
...
public class Runner {
    ...
    public static void ex4() {
        ...
        House house1 = new House("Gagarina", 1);
        House house2 = new House("Lenina", 2);
        City city = new City(new House[]{house1,house2},"Rostov");
        System.out.println(city);
        House house = city.getHouses()[0];
        house.setStreet("Kotova");
        System.out.println(house);
